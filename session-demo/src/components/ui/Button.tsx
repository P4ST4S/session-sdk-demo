...
const Button = ({
  ...
  return (
    <button
      className={`flex flex-col justify-center items-center gap-2 w-[322px] h-[48px] shrink-0 rounded-[12px] text-[#3C3C40] text-center font-poppins text-sm font-medium leading-[110%] ${
        disabled
          ? "bg-gray-200 cursor-not-allowed opacity-60"
          : "bg-[#11E5C5] hover:bg-[#7dffeb] active:bg-[#11e5c57c] cursor-pointer"
      } ${className}`}
      onClick={onClick}
      disabled={disabled}
    >
